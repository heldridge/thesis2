...
A well-known list-decoding algorithm for Reed-Solomon codes is the one devised by Guruswami and Sudan (GS) ~\cite{FOCS:GurSud98}, and indeed we can use their algorithm as the principal component of $\mdssReconstructAlg$ to produce a provably correct scheme.
