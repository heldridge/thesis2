...
The most straightforward approach regulator compliance makes \emph{all} transaction data visible to the authority, for example by encrypting transaction details under the authority's public key.
