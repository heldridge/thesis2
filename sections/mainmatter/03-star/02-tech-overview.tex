...
This requires some careful balancing of parameters, as well as a number of optimizations to ensure a practical level of efficiency. We describe these in \cref{sec:star-impl}.
...
More detailed benchmarks can be found in \cref{sec:star-exp}.
...
For our first experiment in  \cref{sec:star-exp}.
