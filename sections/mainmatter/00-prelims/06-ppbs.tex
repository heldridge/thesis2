...
\begin{definition}[Soundness]
	Let $\ppb = (\setup, \kgen, \verpk, \escrow, \verescrow, \dec)$ be a PPB scheme and let the random variable $\soundgame(\ppb, \adv, \secpar)$ where $\secpar \in \NN$ denote the result of the following experiment:
...
\begin{definition}[Threshold Hiding]
	Let $\ppb = (\setup,\allowbreak \kgen,\allowbreak \verpk,\allowbreak \escrow,\allowbreak \verescrow,\allowbreak \dec)$ be a PPB scheme and let the random variable $\thrhidegame_b(\ppb, \adv, \secpar)$ where $\secpar \in \NN$ and $b \in \bin$ denote the result of the following experiment:
