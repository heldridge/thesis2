...
\begin{proof}
	...
	\vspace{-2em}
	\begin{align*}
		\pker.\dec\left(\revsk_i^j, \left( placeholder
		          \right)^{-1} \cdot \otpct_i^{\rev} \right)
	\end{align*}
	% \begin{align*}
	% 	\pker.\dec( & \revsk_i^j, \otp.\dec(                                                                                                           \\
	% 	            & \otp.\rdec(\otpk_{d - 1}, \pkem.\dec(\matsk_d^{\thr[d] + 1}, \matct_d),\dots,\otpct_{i-1}^{\mat}), \otpct_i^{\rev})) & \neq \bot
	% \end{align*}
	%
	%
	% \begin{align*}
	% 	\pker.\dec(\revsk_i^j, \otp.\dec(\otp.\dec(g^{r'}, \pkem.\dec(\matsk_d^{\thr[d] + 1}, \matct_d)), \otpct_i^{\rev})) & \neq \bot \tag{\cref{lemma:rdecchain}}
	% \end{align*}
\end{proof}
