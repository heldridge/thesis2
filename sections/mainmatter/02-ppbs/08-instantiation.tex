...
We begin by proving that this folklore scheme has the properties we require of it, and then give a transformation from a weak collision-free to a weak robust one.
We then use these tools to describe concretely possible instantiations for $\pker$ and $\pkem$.
