...
\input{sections/mainmatter/02-ppbs/const-figs/04-lossy-elgamal.tex}
...
\input{sections/mainmatter/02-ppbs/const-figs/05-rob-transform.tex}
...
\begin{proof}
	...
	\begin{align*}
		\pker.\dec(\revsk, (\otpk_0^{-1} \cdot \pkem.\dec(\matsk, \matct))^{-1} \cdot (\otpk_1 \cdot \pker.\enc(\revpk, \otpk_3; \rencr))) & \\
		\neq \bot                                                                                                                          &
	\end{align*}

	\vspace{-2em}
	\begin{align*}
		(\otpk_0^{-1} \cdot \pkem.\dec(\matsk, \matct))^{-1} \cdot (\otpk_1 \cdot \pker.\enc(\revpk, \otpk_3; \rencr))                      & = g^{\rkgrB\rencr} \tag{Definition of $\pker$}              \\
		\left(\otpk_0^{-1} \cdot \frac{h^{\mkglr\mencr}\otpk_2}{g^{\mkgir\mencr}}\right)^{-1} \cdot (\otpk_1 \cdot g^{\rkgrA\rencr}\otpk_3) & = g^{\rkgrB\rencr} \tag{Definitions of $\pker$ and $\pkem$} \\
		\frac{\otpk_0\otpk_1\otpk_3 g^{\mkgir\mencr}g^{\rkgrA\rencr}}{\otpk_2h^{\mkglr\mencr}}                                              & = g^{\rkgrB\rencr}                                          \\
		\frac{\otpk_0\otpk_1\otpk_3 g^{\mkgir\mencr}g^{\rkgrA\rencr}}{\otpk_2g^{\rkgrB\rencr}}                                              & = h^{\mkglr\mencr}                                          \\
