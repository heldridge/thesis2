\begin{titlepage}
	...
	\begin{center} \singlespacing \thispagestyle{empty}
		...
		\ThesisTitle{New Techniques in Secret Sharing and Private Threshold Aggregation Protocols}

		\vspace{1in}                    % gap between the title and the author: approx. 1 inch

		\ThesisAuthor{Harry Eldridge}         % author name for the thesis
		...
		\ThesisDate{September}{2026}        % thesis submission month and year (single-spaced)
		...
		\ThesisCopyright{2026}{Harry Eldridge}
